...
public class Automatas {
    ...
    public boolean AutomataIdentificador(String cadena){
        ...
        int estado = 0;     int i = 0;   int caracter; 
        ...
        while(i<cadena.length() && estado!=2 && subtoken.equals("")){
            ...
            switch(estado){
                ...
                case 0: if( (caracter>64 && caracter<91) || (caracter>96 && caracter<123))                
                            estado = 1;                 
                        else
                            estado = 2;
                        break;

                case 1: if((caracter>64 && caracter<91) || (caracter>96 && caracter<123) || (caracter>47 && caracter<58) || caracter==95)                
                            estado = 1;                                            
                        else{
      ...
      public int AutomataCadena(String cadena, int estado){
        ...
        while(i<cadena.length() && estado!=3 && subtoken.equals("")){
            ...
            switch(estado){
                ...
                case 0: if(caracter==34)                
                            estado = 1;                 
                        else
                            estado = 3;
                        break;

                case 1: if(caracter!=34)                
                            estado = 1;                                            
                        else {
                        if (caracter == 34) {
                            estado = 2;
